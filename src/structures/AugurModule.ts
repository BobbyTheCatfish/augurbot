...
export class AugurModule {
     ...
     */
    addInteraction<K extends keyof NoAutoComplete | undefined, G extends opBool, D extends opBool>(info: AugurInteractionInfo<K, G, D>) {
        this.interactions.push(new AugurInteraction(info, this.client));
        return this;
    }
     ...
     */
    setUnload(unload: UnloadFunction) {
        this.unload = unload;
        return this;
    }
}